...
public class QuoteGenerator
{
    public String getQuote() {
        final String[] quoteArray = new String[]{
                ...
                "to Zuko It's a lovely night for a walk. Why don't you join me? It would clear your head. no responseOr, just stay in your room and sit in the dark. Whatever makes you happy.",
                ...
                "IM BEGGING YOU, PRINCE ZUKO! It's time for you to look inward and start asking yourself the big question: who are you and what do YOU want?",
